...
variable "s3_bucket_name" {
  type        = string
  default     = "alvee-aws-terraform-state-backend"
  description = "S3 bucket for holding Terraform state files. If not provided, the name will be generated by the label module in the format namespace-stage-name"
}
